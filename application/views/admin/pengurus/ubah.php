                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <?php foreach($pengurus as $row_pengurus){?>
                                <form id="validationform" action="<?= site_url('Admin/Pengurus/update_data')?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="nama_pengurus" id="nama_pengurus" placeholder="Nama pengurus" class="form-control" required value="<?= $row_pengurus->nama_pengurus?>">
                                            <input type="hidden" name="id_pengurus" id="id_pengurus" class="form-control" required value="<?= $row_pengurus->id_pengurus?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">No Telp</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="notelp_pengurus" placeholder="Nomer Telp" class="form-control" value="<?= $row_pengurus->notelp_pengurus?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Keterangan</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" value="<?= $row_pengurus->ket_pengurus?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
