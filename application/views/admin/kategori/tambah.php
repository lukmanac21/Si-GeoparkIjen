                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="validationform" action="<?= site_url('Admin/kategori/save_data')?>" method="post">
                                    <div class="form-group row">
                                        <label for="nama_kategori" class="col-12 col-sm-3 col-form-label text-sm-right">Nama Kategori</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="nama_kategori" id="nama_kategori" placeholder="Nama kategori" class="form-control" required>
                                        </div>
                                    </div>
