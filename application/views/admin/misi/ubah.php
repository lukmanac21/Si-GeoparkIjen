                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <?php foreach($misi as $row_misi){?>
                                <form id="validationform" action="<?= site_url('Admin/misi/update_data')?>" method="post">
                                    <div class="form-group row">
                                        <label for="ket_misi" class="col-12 col-sm-3 col-form-label text-sm-right">Keterangan Misi</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="ket_misi" id="ket_misi" placeholder="ket misi" class="form-control" value="<?= $row_misi->ket_misi?>" required>
