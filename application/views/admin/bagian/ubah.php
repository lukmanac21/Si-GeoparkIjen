                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <?php foreach($bagian as $row_bagian){?>
                                <form id="validationform" action="<?= site_url('Admin/bagian/update_data')?>" method="post">
                                    <div class="form-group row">
                                        <label for="nama_bagian" class="col-12 col-sm-3 col-form-label text-sm-right">Nama bagian</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="nama_bagian" id="nama_bagian" placeholder="Nama bagian" class="form-control" value="<?= $row_bagian->nama_bagian?>" required>
