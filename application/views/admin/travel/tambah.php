                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="validationform" action="<?= site_url('Admin/Travel/save_data')?>" method="post">
                                    <div class="form-group row">
                                        <label for="nama_travel" class="col-12 col-sm-3 col-form-label text-sm-right">Nama Travel</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="nama_travel" id="nama_travel" placeholder="Nama travel" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Alamat</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="alamat_travel" placeholder="Alamat" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Email</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="email" name="email_travel" placeholder="Email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">No Telp</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="notelp_travel" placeholder="Nomer Telp" class="form-control">
                                        </div>
                                    </div>
