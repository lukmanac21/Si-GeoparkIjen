                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="validationform" action="<?= site_url('Admin/slider/save_data')?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label for="judul_slider" class="col-12 col-sm-3 col-form-label text-sm-right">Judul Slider</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="judul_slider" id="judul_slider" placeholder="Judul slider" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
