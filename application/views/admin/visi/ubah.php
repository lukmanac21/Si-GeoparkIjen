                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <?php foreach($visi as $row_visi){?>
                                <form id="validationform" action="<?= site_url('Admin/visi/update_data')?>" method="post">
                                    <div class="form-group row">
                                        <label for="ket_visi" class="col-12 col-sm-3 col-form-label text-sm-right">Keterangan Visi</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="ket_visi" id="ket_visi" placeholder="ket visi" class="form-control" value="<?= $row_visi->ket_visi?>" required>
                                    ...
                                    <div class="form-group row text-right">
                                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                            ...
                                            <a href="<?= site_url('Admin/visi');?>" class="btn btn-space btn-secondary">Kembali</a>
                                        </div>
                                    </div>
                                </form>
                            <?php } ?>
