                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="validationform" action="<?= site_url('Admin/layanan/save_data')?>" method="post">
                                    <div class="form-group row">
                                        <label for="nama_layanan" class="col-12 col-sm-3 col-form-label text-sm-right">Nama Layanan</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" name="nama_layanan" id="nama_layanan" placeholder="Nama layanan" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
