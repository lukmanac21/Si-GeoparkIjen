<script src="<?= base_url();?>assets/admin/vendor/jquery/jquery-3.3.1.min.js"></script>
    ...
    <script src="<?= base_url();?>assets/admin/vendor/bootstrap-select/js/bootstrap-select.js"></script>
    ...
    <script src="<?= base_url();?>assets/admin/vendor/summernote/js/summernote-bs4.js"></script>
